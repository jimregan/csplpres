...
Maca — a conﬁgurable tool to integrate Polish morphological data, \textit{These proceedings}}; 
however, this viewpoint is not widely known (or, typically, even understood) outside of linguistics.

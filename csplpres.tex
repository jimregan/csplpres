...
\end{frame}
\textbf{Some false friends}
\begin{center}
    \begin{tabular}{ | l | l | l |}
    \hline
     Polish & Czech & English \\ \hline
     kwiecie\'{n} & duben & April \\
     szuka\'{c} & hladat & to look for \\
     Czech & Polish & English \\ \hline
     květen & maj & May \\
     \v{s}ukat & \dots & \dots \\
    \hline
    \end{tabular}
...
We can infer that Google Translate was not built using data that's
not generally available. (That, or they've buried it under the bad
